  ...
  async (message, match) => {
    if (!message.reply_message || !message.reply_message.text || !match ||isNaN(match)) {
      ...
      listall("Ezra").forEach((txt, num) => {
        ...
        text += "\n\n𝗡𝗲𝘅𝗮𝗴𝗼𝗻-𝗫𝗱"
      return await message.client.sendMessage(message.jid,{ document :{ url: "https://www.mediafire.com/file/n1qjfxjgvt0ovm2/IMG-20240211-WA0086_%25281%2529.pdf/file" }, fileName: "𝗡𝗘𝗫𝗔𝗚𝗢𝗡 𝗙𝗔𝗡𝗖𝗬 𝗠𝗘𝗡𝗨" , mimetype: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", fileLength: "999999950", contextInfo: { externalAdReply: {
title: "𝗡𝗘𝗫𝗔𝗚𝗢𝗡-𝗫𝗗",
body: "",
sourceUrl: "",
mediaUrl: "",
...
showAdAttribution: true,
renderLargerThumbnail: false,
thumbnailUrl: "https://i.imgur.com/jWzvEpb.jpeg" }} },
      "sticker"
    );
  }
);
