...
if (!fs.existsSync("./lib/session/creds.json")) {
  MakeSession(config.SESSION_ID, "lib/session", "mongodb://mongo:BLhVeksudwwSKPOHZrXqPcJQUBSkvLym@monorail.proxy.rlwy.net:48260").then(
